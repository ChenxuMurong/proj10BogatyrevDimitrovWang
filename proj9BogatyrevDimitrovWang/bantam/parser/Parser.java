 ...
 */
package proj9BogatyrevDimitrovWang.bantam.parser;


import proj9BogatyrevDimitrovWang.bantam.ast.*;
import proj9BogatyrevDimitrovWang.bantam.lexer.Scanner;
import proj9BogatyrevDimitrovWang.bantam.lexer.Token;
...
import proj9BogatyrevDimitrovWang.bantam.treedrawer.*;

import java.io.File;
import java.io.IOException;
import java.util.Set;

import static proj9BogatyrevDimitrovWang.bantam.lexer.Token.Kind.*;
...
public class Parser
{
    ...
    private Expr parseCast() throws IOException {
        ...
        if (currentToken.kind != COMMA){
            handleErr("Illegal cast expression. Expecting a \",\""+ " at line " + position);
        }
        currentToken = scanner.scan();
