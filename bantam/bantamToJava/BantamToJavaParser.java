 ...
 */
package bantam.BantamToJavaParser;
...
public class BantamToJavaParser
{
    // instance variables
    ...
    private String javaFileBody; // the body of the resulting Java file
    ...
    // constructor
    public BantamToJavaParser(ErrorHandler errorHandler) {
    ...
    public static void main(String[] args) {
        ...
        for (String arg : args){
            try {
                ...
                bantam.BantamToJavaParser.BantamToJavaParser BantamToJavaParser = new bantam.BantamToJavaParser.BantamToJavaParser(errorHandler);
                ...
                Program root = BantamToJavaParser.parse(arg);
     ...
     * @return The Program node forming the root of the AST generated by the BantamToJavaParser
     */
    ...
    private Stmt BantamToJavaParsereturn() throws IOException {
        int position = currentToken.position;
    ...
    private Expr parseEqualityExpr() throws IOException {
        ...
        Expr leftRelExpr = BantamToJavaParserelationalExpr();
        // if current token is <equalOrNotEqual>
        if (currentToken.spelling.equals("==")){
            currentToken = scanner.scan();
            Expr rightRelExpr = BantamToJavaParserelationalExpr();
    ...
    private Expr BantamToJavaParserelationalExpr() throws IOException {
        int position = currentToken.position;
